        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="com-sm-2 text-right">
                        <div class="font-size-20 text-danger font-baloo">
                            $<span class="product_prize">152</span>
                        </div>
                    </div>
                </div>
                <!--/cart item-->
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="qty d-flex p-2">
                            <div class="d-flex font-rale w-25">
                                ...
                                <button data-id="pro2" class="qty-down border bg-light "><i class="fas fa-angle-down p-0 m-0"></i></button>
                            </div>
                            <button type="submit" class="btn font-baloo text-danger px-3 border-right">Delete</button>
                            <button type="submit" class="btn font-baloo text-danger ">Save For Later</button>
                        </div>
            ...
            <!--subtotal section-->
            <div class="col-sm-3">
                <div class="subt-total border text-center mt-2">
                    <h6 class="font-size-12 font-rale text-success py-3"> <i class="fas fa-check"></i> You order is eligble for FREE delivery</h6>
