...
<section id="blogs">
    <div class="container py-4">
        <h4 class="font-rubik  font-size-20">Latests Blogs</h4>
        <hr>
        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="card border-0 font-rale mr-5 " style="width :18rem;">
                    ...
                    <p class="card-text font-size-14 text-black-50 py-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit esse natus, nihil illum nemo molestias distinctio ex optio illo necessitatibus.</p>
